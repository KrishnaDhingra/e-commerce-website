...
export let product_data = [
    {
        ...
        in_box: [
            {quantity: '1x', material: 'Headphone Unit'},
...

    {
        ...
        in_box: [
            {quantity: '2x', material: 'Speaker Unit'},
            {quantity: '2x', material: 'Speaker Cloth Panel'},
            {quantity: '1x', material: 'User Manual'},
            {quantity: '1x', material: '3.5mm 5m Audio Cable'},
...

    {
        ...
        in_box: [
            {quantity: '2x', material: 'Earphone Unit'},
            {quantity: '6x', material: 'Multi-Size Earplugs'},
            {quantity: '1x', material: 'User Manual'},
